        ...
        <div className="">
            <nav className="navbar navbar-expand-lg navbar-light bg-dark container-fluid sticky-top">
                <div className="container">
                    <Link className="navbar-brand fw-bold text-danger" to="/home">EYE CARE</Link>
                    ...
                    <div className="collapse navbar-collapse" id="navbarText">
                        ...
                        <div className="d-flex justify-content-end">
                            <span className="navbar-text fw-bold text-dark bg-light  rounded-pill">
                                {user?.email}
                            </span>
                            {user?.email ?
                                <button onClick={logOut} className="bg-light p-2 fw-bold text-dark rounded-pill">Log out</button>
                                :
